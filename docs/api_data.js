        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "BadPage",
            "description": "<p>The page parameter is &lt; 1.</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "BadItemsPerPage",
            "description": "<p>The itemsPerPage parameter is &lt; 1.</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "ConflictingSurvey",
            "description": "<p>The Survey object you are trying to insert is already in the DB. You are likely trying to update it, so you should use HTTP PUT verb instead.</p>"
          }
        ]
      },
      "examples": [
        ...
        {
          "title": "ConflictingSurvey-Example-Response:",
